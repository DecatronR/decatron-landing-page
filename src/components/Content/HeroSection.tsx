        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-9 flex flex-col items-center justify-center space-y-5 sm:flex-row sm:space-y-0 sm:space-x-5">
            <a
              ...
              className="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium text-white bg-primary rounded-md sm:px-5 sm:py-2 sm:text-base"
              role="button"
            >
              Join Waiting list
            </a>
            ...
            <a
              href="#"
              title="Learn More"
              className="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium text-white bg-black rounded-md sm:px-5 sm:py-2 sm:text-base"
              role="button"
            >
              <svg
